...
public struct URLSessionAnyTaskConfig: URLSessionAnyTaskConfigurationProtocol {
    ...
    public init(taskDescription: String? = nil, earliestBeginDate: Date? = nil, countOfBytesClientExpectsToSend: Int64? = nil, countOfBytesClientExpectsToReceive: Int64? = nil, priority: Float? = nil, prefersIncrementalDelivery: Bool? = nil) {
