...
public class UploadTaskOperationController: AsynchronousOperation,
                                            UploadTaskOperationControllerProtocol {
    
    public typealias TaskConfiguration = UploadTaskConfig
    
    public var taskConfiguration: UploadTaskConfig
    ...
    public init(operationQueue: OperationQueue?,
                sessionTask: @autoclosure () -> (UploadTaskOperationController.SessionTask),
                operationConfig: OperationConfig,
                autoUpdateTaskConfigOnChange:Bool = true,
                uploadTaskConfig: UploadTaskConfig = UploadTaskConfig()) {
        self.autoUpdateTaskConfigOnChange = autoUpdateTaskConfigOnChange
        self.taskConfiguration = uploadTaskConfig
    ...
    @discardableResult
    public func changeTaskConfiguration(_ config: (inout UploadTaskConfig) -> Void) -> Self {
...
extension UploadTaskOperationController {
